    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="glass-panel border-white/10 p-8 w-full max-w-md animate-scale-in relative z-10 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2 animate-fade-in">NeuroPulse AI</h1>
          <p className="text-white/60 animate-fade-in-delay">Next-generation content intelligence platform</p>
        </div>
